...
function addTransactionDOM(transaction){
    ...
    <i class="fa-solid fa-caret-${icon}"></i><i class="fas fa-trash-alt delete " onclick="removeItem(${transaction.id})></i></span>`;
...
function updateValue(params){
   ...
   moneyMinus.innerHTML=`$${Math.abs(expense).toFixed(2)}<i class="fa-solid fa-caret-down"></i>`;
